...
### note update on this bot: We will be starting to work on this bot during thanksgiving (too much school in the last few months). I'm sorry if you are having problems while using this bot. Once again, the bot is depended on wither if you configured the bot right or wrong.
